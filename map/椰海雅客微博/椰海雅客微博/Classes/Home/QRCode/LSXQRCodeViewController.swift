...
//MARK: 懒加载
    ...
    lazy var tabBar:UITabBar = {
       let tabBar = UITabBar()
        ...
        tabBar.tintColor = SystemTintColor
...
//MARK: 系统方法
    override func viewDidLoad() {
        ...
        //: 导航栏
        navigationItem.leftBarButtonItem = UIBarButtonItem(title: "关闭", style: .plain, target: self, action: #selector(closeScanQRCode))
        
        navigationItem.rightBarButtonItem = UIBarButtonItem(title: "相册", style: .plain, target: self, action: #selector(openPhotoLibrary))
